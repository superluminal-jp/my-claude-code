...
#        TEST_MODEL=opus bash tests/run-live-documentation.sh   # override eval model (default: haiku)
#
...
VALID_KEYWORDS="drift violation autogen proximity override-rejected"
...
printf "\n${BOLD}Live Documentation Tests${NC}  [model: %s]\n" "$TEST_MODEL"
echo "========================"
echo ""
