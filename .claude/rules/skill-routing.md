...
- Scrum and agile facilitation -> load `scrum-master`, **when Scrum or agile practice is the actual subject of the request**. Covers Scrum events (planning, daily, review, retrospective, refinement), Definition of Done, impediment removal, flow and quality metrics (velocity, burndown, cycle time, WIP), team dysfunction, and scaling frameworks (Nexus/LeSS/SAFe). Applies with or without a team: self-facilitation for one person's own work — personal weekly planning, daily check-ins, a solo retrospective — routes here too.
